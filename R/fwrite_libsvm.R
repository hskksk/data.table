fwrite_libsvm <- function(x, file="", append=FALSE, quote="auto",
    ...
    # validate arguments
    stopifnot(is.data.frame(x) || is.list(x), ncol(x) > 0L, isLOGICAL(quote), 
    ...
    .Call(Cwritefile_libsvm, x, file, sep, eol, na, quote, qmethod == "escape", append, col.names, verbose, turbo)
